class classHuyenQuan {
    ...
    static getQuanHuyen = (tinh) => {
        let huyenCuaTinh = []
        if (tinh) {
            for (let item in this.huyen_quan) {
                if (this.huyen_quan[item].parent_code === tinh.code) {
                    huyenCuaTinh.push(this.huyen_quan[item])
                }
            }
        }
        return huyenCuaTinh
